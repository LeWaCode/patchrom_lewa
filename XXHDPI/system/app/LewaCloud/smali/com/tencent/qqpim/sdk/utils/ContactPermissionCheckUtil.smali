.class public Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;
.super Ljava/lang/Object;


# static fields
.field private static final DELETED:Ljava/lang/String; = "1"

.field private static final NAME:Ljava/lang/String; = "GG_A_R_A_NAME"

.field private static final TAG:Ljava/lang/String; = "ContactPermissionCheckUtil"

.field private static final TYPE:Ljava/lang/String; = "GG_A_R_A_TYPE"

.field private static isContactDeny:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->isContactDeny:Z
...
.method public static checkContactAggregationNeeded()Z
    .locals 4

    const/4 v0, 0x1

    const-string v1, "GG_A_R_A_TYPE"

    const-string v2, "GG_A_R_A_NAME"

    const-string v3, "1"

    invoke-static {v1, v2, v3, v0}, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->insertItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->deleteItem(Ljava/lang/String;)I

    move-result v1

    if-nez v1, :cond_0

    const-string v1, "ContactPermissionCheckUtil"

    const-string v2, "checkContactPermissionDeny deleteItem fail."
...
.method public static checkContactPermissionDeny()Z
    .locals 4

    const/4 v3, 0x0

    const-string v0, "GG_A_R_A_TYPE"

    const-string v1, "GG_A_R_A_NAME"

    const-string v2, "1"

    invoke-static {v0, v1, v2, v3}, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->insertItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sput-boolean v3, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->isContactDeny:Z

    invoke-static {v0}, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->deleteItem(Ljava/lang/String;)I

    move-result v0

    if-nez v0, :cond_0

    const-string v0, "ContactPermissionCheckUtil"

    const-string v1, "checkContactPermissionDeny deleteItem fail."

    invoke-static {v0, v1}, Lcom/tencent/qqpim/sdk/utils/log/Plog;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    :goto_0
    sget-boolean v0, Lcom/tencent/qqpim/sdk/utils/ContactPermissionCheckUtil;->isContactDeny:Z
...
.method private static deleteItem(Ljava/lang/String;)I
    .locals 6
    ...
    const-string v2, "ContactPermissionCheckUtil"
...
.method private static insertItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    .locals 5
...
.method public static isContactPermissionDeny()Z
    .locals 1
...
.method private static queryItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    ...
    const-string v3, "account_type = ? AND account_name = ? AND deleted = ?"
...
.method private static updateItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    .locals 6
