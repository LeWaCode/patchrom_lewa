.class final enum Lcom/lewa/guava/collect/MapMaker$Strength$2;
...
.method copyEntry(Ljava/lang/Object;Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;)Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;
    ...
    check-cast v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;

    .line 425
    .local v0, from:Lcom/lewa/guava/collect/MapMaker$SoftEntry;,"Lcom/lewa/guava/collect/MapMaker$SoftEntry<TK;TV;>;"
    if-nez p3, :cond_0

    new-instance v1, Lcom/lewa/guava/collect/MapMaker$SoftEntry;

    iget-object v2, v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;->internals:Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;

    iget v3, v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;->hash:I

    invoke-direct {v1, v2, p1, v3}, Lcom/lewa/guava/collect/MapMaker$SoftEntry;-><init>(Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;Ljava/lang/Object;I)V

    :goto_0
    return-object v1

    :cond_0
    new-instance v1, Lcom/lewa/guava/collect/MapMaker$LinkedSoftEntry;

    iget-object v2, v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;->internals:Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;

    iget v3, v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;->hash:I

    invoke-direct {v1, v2, p1, v3, p3}, Lcom/lewa/guava/collect/MapMaker$LinkedSoftEntry;-><init>(Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;Ljava/lang/Object;ILcom/lewa/guava/collect/MapMaker$ReferenceEntry;)V
...
.method newEntry(Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;Ljava/lang/Object;ILcom/lewa/guava/collect/MapMaker$ReferenceEntry;)Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;
    ...
    new-instance v0, Lcom/lewa/guava/collect/MapMaker$SoftEntry;

    invoke-direct {v0, p1, p2, p3}, Lcom/lewa/guava/collect/MapMaker$SoftEntry;-><init>(Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;Ljava/lang/Object;I)V

    :goto_0
    return-object v0

    :cond_0
    new-instance v0, Lcom/lewa/guava/collect/MapMaker$LinkedSoftEntry;

    invoke-direct {v0, p1, p2, p3, p4}, Lcom/lewa/guava/collect/MapMaker$LinkedSoftEntry;-><init>(Lcom/lewa/guava/collect/CustomConcurrentHashMap$Internals;Ljava/lang/Object;ILcom/lewa/guava/collect/MapMaker$ReferenceEntry;)V
...
.method referenceValue(Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;Ljava/lang/Object;)Lcom/lewa/guava/collect/MapMaker$ValueReference;
    ...
    invoke-direct {v0, p2, p1}, Lcom/lewa/guava/collect/MapMaker$SoftValueReference;-><init>(Ljava/lang/Object;Lcom/lewa/guava/collect/MapMaker$ReferenceEntry;)V
